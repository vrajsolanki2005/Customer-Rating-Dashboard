...
const createStoreSchema = z.object({
  name: z.string().trim().min(10, "Store name must be at least 10 characters").max(60, "Store name must be at most 60 characters"),
  email: z.string().trim().email("Please provide a valid email address"),
  address: z.string().trim().max(400, "Address must be at most 400 characters"),
...
const updateUserSchema = z.object({
  name: z.string().trim().min(10, "Name must be at least 10 characters").max(60, "Name must be at most 60 characters").optional(),
...
const updateStoreSchema = z.object({
  name: z.string().trim().min(10, "Store name must be at least 10 characters").max(60, "Store name must be at most 60 characters").optional(),
  email: z.string().trim().email("Please provide a valid email address").optional(),
  address: z.string().trim().max(400, "Address must be at most 400 characters").optional(),
  ownerId: z.number().int().positive().optional().nullable(),
});

module.exports = { createUserSchema, createStoreSchema, updateUserSchema, updateStoreSchema };
